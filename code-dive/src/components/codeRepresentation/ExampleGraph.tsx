...
import { DiagramWrapper } from './Diagrams/Example/Diagram';
...
class ExampleGraph extends React.Component<{}, ExampleGraphState> {
  ...
  public handleDiagramEvent(e: go.DiagramEvent) {
    ...
    switch (name) {
      case 'ChangedSelection': {
        ...
        this.setState(
            produce((draft: ExampleGraphState) => {
              if (sel) {
